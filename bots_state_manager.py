...
from bot_engine.legacy_adapter import LegacyStateAdapter
...
def init_bot_service():
    ...
    try:
        ...
        # Создаем адаптер для совместимости со старыми endpoints
        legacy_adapter = LegacyStateAdapter(bot_system_state)
        state_dict = legacy_adapter.get_legacy_state_dict()
...
if __name__ == '__main__':
    ...
    from bots_legacy import check_and_stop_existing_bots_processes
