...
> Менеджер работает пошагово: 1) установка зависимостей (системный Python), 2) опциональное управление `.venv`, 3) обновления Git, 4) лицензия (опционально), 5) запуск сервисов, 6) документация, 7) логи.
