...
- 🧱 **Entry Filters Reuse**: AI симуляции теперь вызывают те же RSI time filter и ExitScam проверки, что и боевой контур (`bot_engine/ai/filter_utils.py`), поэтому результаты обучения/бэктеста учитывают реальные блокировки сигналов.
