    ...
    try:
        ...
        if not candles:
            ...
            with _exchange_api_semaphore:
                ...
                data_source = 'api'
 - DEBUG - 💰 CTC: ФИНАЛЬНО: 2.0 монет @ 0.32970000 (кратно 1.0)
[BOTS] 02:41:05 - DEBUG - 🎯 CTC: order_params={'category': 'linear', 'symbol': 'CTCUSDT', 'side': 'Buy', 'orderType': 'Market', 'qty': '2', 'positionIdx': 1}
[BOTS] 02:41:05 - DEBUG - 🔍 CTC: ДЕТАЛИ: qty='2' монет, orderType='Market'
[BOTS] 02:41:05 - DEBUG - Параметры ордера: {'category': 'linear', 'symbol': 'CTCUSDT', 'side': 'Buy', 'orderType': 'Market', 'qty': '2', 'positionIdx': 1}
[BOTS] 02:41:05 - DEBUG - 🔍 CTC: ОТПРАВЛЯЕМ ЗАПРОС в Bybit API...
[BOTS] 02:41:05 - ERROR - ❌ CTC: Pybit exception: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:05).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Market", "qty": "2", "positionIdx": 1}.
[BOTS] 02:41:05 - ERROR - Ошибка размещения ордера: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:05).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Market", "qty": "2", "positionIdx": 1}.
[BOTS] 02:41:05 - ERROR - Трейсбек: Traceback (most recent call last):
  File "C:\PROJECTS\InfoBot\exchanges\bybit_exchange.py", line 1978, in place_order
    raise api_error  # Пробрасываем дальше
    ^^^^^^^^^^^^^^^
  File "C:\PROJECTS\InfoBot\exchanges\bybit_exchange.py", line 1966, in place_order
    response = self.client.place_order(**order_params)
  File "C:\Users\evro7\AppData\Local\Packages\PythonSoftwareFoundation.Python.3.13_qbz5n2kfra8p0\LocalCache\local-packages\Python313\site-packages\pybit\_v5_trade.py", line 21, in place_order
    ...
    ^
  File "C:\Users\evro7\AppData\Local\Packages\PythonSoftwareFoundation.Python.3.13_qbz5n2kfra8p0\LocalCache\local-packages\Python313\site-packages\pybit\_http_manager.py", line 197, in _submit_request
    return self._handle_response(response, method, path, req_params, recv_window, retries_attempted)
           ~~~~~~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "C:\Users\evro7\AppData\Local\Packages\PythonSoftwareFoundation.Python.3.13_qbz5n2kfra8p0\LocalCache\local-packages\Python313\site-packages\pybit\_http_manager.py", line 282, in _handle_response
    raise InvalidRequestError(
    ...<5 lines>...
    )
pybit.exceptions.InvalidRequestError: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:05).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Market", "qty": "2", "positionIdx": 1}.
[BOTS] 02:41:05 - DEBUG -  CTC: 📋 Ордер #2: percent_step=0.5%, margin_amount=0.75 USDT (из массива margin_amounts[1]=0.75)
[BOTS] 02:41:05 - DEBUG -  CTC: ✅ Используем для ордера #2: 0.75 USDT (self.volume_value=5, НЕ используется!)
[BOTS] 02:41:05 - DEBUG -  CTC: 🚀 Размещаем лимитный ордер #2: 0.75 USDT @ 0.328051 (0.5%)
[BOTS] 02:41:05 - DEBUG -  CTC: ✅ Используем 0.75 USDT из массива margin_amounts[1]=0.75, НЕ self.volume_value=5
[BOTS] 02:41:06 - DEBUG - 📊 Текущая цена CTC: 0.3297
[BOTS] 02:41:06 - DEBUG - 📊 CTC: minNotionalValue=5.0 USDT, minOrderQty=1.0, qtyStep=1.0
[BOTS] 02:41:06 - DEBUG - 📊 CTC: Плечо с биржи: 10.0x
[BOTS] 02:41:06 - DEBUG - 🎯 CTC: Запрошенная сумма из конфига: 0.75 USDT
[BOTS] 02:41:06 - DEBUG - 🔍 CTC: Исходное количество монет: 2.27
[BOTS] 02:41:06 - DEBUG - 🔍 CTC: Округлили 2.27 до 3.0 монет (кратно 1.0)
[BOTS] 02:41:06 - DEBUG - 🔍 CTC: Запрошенная сумма 0.99 USDT < minNotionalValue=5.0, но пропускаем принудительное увеличение (лимитный ордер из набора)
[BOTS] 02:41:06 - DEBUG - 💰 CTC: ФИНАЛЬНО: 3.0 монет @ 0.32970000 (кратно 1.0)
[BOTS] 02:41:06 - DEBUG - 🎯 CTC: order_params={'category': 'linear', 'symbol': 'CTCUSDT', 'side': 'Buy', 'orderType': 'Limit', 'qty': '3', 'positionIdx': 1}
[BOTS] 02:41:06 - DEBUG - 🔍 CTC: ДЕТАЛИ: qty='3' монет, orderType='Limit'
[BOTS] 02:41:06 - DEBUG - Параметры ордера: {'category': 'linear', 'symbol': 'CTCUSDT', 'side': 'Buy', 'orderType': 'Limit', 'qty': '3', 'positionIdx': 1, 'price': '0.328051', 'timeInForce': 'GTC'}
[BOTS] 02:41:06 - DEBUG - 🔍 CTC: ОТПРАВЛЯЕМ ЗАПРОС в Bybit API...
[BOTS] 02:41:06 - ERROR - ❌ CTC: Pybit exception: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:06).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "3", "positionIdx": 1, "price": "0.328051", "timeInForce": "GTC"}.
[BOTS] 02:41:06 - ERROR - Ошибка размещения ордера: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:06).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "3", "positionIdx": 1, "price": "0.328051", "timeInForce": "GTC"}.
[BOTS] 02:41:06 - ERROR - Трейсбек: Traceback (most recent call last):
  File "C:\PROJECTS\InfoBot\exchanges\bybit_exchange.py", line 1978, in place_order
    raise api_error  # Пробрасываем дальше
    ^^^^^^^^^^^^^^^
  File "C:\PROJECTS\InfoBot\exchanges\bybit_exchange.py", line 1966, in place_order
...
pybit.exceptions.InvalidRequestError: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:06).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "3", "positionIdx": 1, "price": "0.328051", "timeInForce": "GTC"}.
[BOTS] 02:41:06 - WARNING -  CTC: ⚠️ Не удалось разместить лимитный ордер #2: Ошибка размещения ордера: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:06).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "3", "positionIdx": 1, "price": "0.328051", "timeInForce": "GTC"}.
[BOTS] 02:41:06 - DEBUG -  CTC: 📋 Ордер #3: percent_step=1%, margin_amount=1 USDT (из массива margin_amounts[2]=1)
[BOTS] 02:41:06 - DEBUG -  CTC: ✅ Используем для ордера #3: 1 USDT (self.volume_value=5, НЕ используется!)
[BOTS] 02:41:06 - DEBUG -  CTC: 🚀 Размещаем лимитный ордер #3: 1 USDT @ 0.326403 (1%)
[BOTS] 02:41:06 - DEBUG -  CTC: ✅ Используем 1 USDT из массива margin_amounts[2]=1, НЕ self.volume_value=5
[BOTS] 02:41:06 - DEBUG - 📊 Текущая цена CTC: 0.3297
[BOTS] 02:41:07 - DEBUG - 📊 CTC: minNotionalValue=5.0 USDT, minOrderQty=1.0, qtyStep=1.0
[BOTS] 02:41:07 - DEBUG - 📊 CTC: Плечо с биржи: 10.0x
[BOTS] 02:41:07 - DEBUG - 🎯 CTC: Запрошенная сумма из конфига: 1.0 USDT
[BOTS] 02:41:07 - DEBUG - 🔍 CTC: Исходное количество монет: 3.03
[BOTS] 02:41:07 - DEBUG - 🔍 CTC: Округлили 3.03 до 4.0 монет (кратно 1.0)
[BOTS] 02:41:07 - DEBUG - 🔍 CTC: Запрошенная сумма 1.32 USDT < minNotionalValue=5.0, но пропускаем принудительное увеличение (лимитный ордер из набора)
[BOTS] 02:41:07 - DEBUG - 💰 CTC: ФИНАЛЬНО: 4.0 монет @ 0.32970000 (кратно 1.0)
[BOTS] 02:41:07 - DEBUG - 🎯 CTC: order_params={'category': 'linear', 'symbol': 'CTCUSDT', 'side': 'Buy', 'orderType': 'Limit', 'qty': '4', 'positionIdx': 1}
[BOTS] 02:41:07 - DEBUG - 🔍 CTC: ДЕТАЛИ: qty='4' монет, orderType='Limit'
[BOTS] 02:41:07 - DEBUG - Параметры ордера: {'category': 'linear', 'symbol': 'CTCUSDT', 'side': 'Buy', 'orderType': 'Limit', 'qty': '4', 'positionIdx': 1, 'price': '0.326403', 'timeInForce': 'GTC'}
[BOTS] 02:41:07 - DEBUG - 🔍 CTC: ОТПРАВЛЯЕМ ЗАПРОС в Bybit API...
[BOTS] 02:41:07 - ERROR - ❌ CTC: Pybit exception: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:07).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "4", "positionIdx": 1, "price": "0.326403", "timeInForce": "GTC"}.
[BOTS] 02:41:07 - ERROR - Ошибка размещения ордера: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:07).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "4", "positionIdx": 1, "price": "0.326403", "timeInForce": "GTC"}.
[BOTS] 02:41:07 - ERROR - Трейсбек: Traceback (most recent call last):
  File "C:\PROJECTS\InfoBot\exchanges\bybit_exchange.py", line 1978, in place_order
    raise api_error  # Пробрасываем дальше
    ^^^^^^^^^^^^^^^
  File "C:\PROJECTS\InfoBot\exchanges\bybit_exchange.py", line 1966, in place_order
...
pybit.exceptions.InvalidRequestError: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:07).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "4", "positionIdx": 1, "price": "0.326403", "timeInForce": "GTC"}.
[BOTS] 02:41:07 - WARNING -  CTC: ⚠️ Не удалось разместить лимитный ордер #3: Ошибка размещения ордера: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:07).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "4", "positionIdx": 1, "price": "0.326403", "timeInForce": "GTC"}.
[BOTS] 02:41:07 - DEBUG -  CTC: 📋 Ордер #4: percent_step=1.5%, margin_amount=1.25 USDT (из массива margin_amounts[3]=1.25)
[BOTS] 02:41:07 - DEBUG -  CTC: ✅ Используем для ордера #4: 1.25 USDT (self.volume_value=5, НЕ используется!)
[BOTS] 02:41:07 - DEBUG -  CTC: 🚀 Размещаем лимитный ордер #4: 1.25 USDT @ 0.324755 (1.5%)
[BOTS] 02:41:07 - DEBUG -  CTC: ✅ Используем 1.25 USDT из массива margin_amounts[3]=1.25, НЕ self.volume_value=5
[BOTS] 02:41:07 - DEBUG - 📊 Текущая цена CTC: 0.3297
[BOTS] 02:41:07 - DEBUG - 📊 CTC: minNotionalValue=5.0 USDT, minOrderQty=1.0, qtyStep=1.0
[BOTS] 02:41:08 - DEBUG - 📊 CTC: Плечо с биржи: 10.0x
[BOTS] 02:41:08 - DEBUG - 🎯 CTC: Запрошенная сумма из конфига: 1.25 USDT
[BOTS] 02:41:08 - DEBUG - 🔍 CTC: Исходное количество монет: 3.79
[BOTS] 02:41:08 - DEBUG - 🔍 CTC: Округлили 3.79 до 4.0 монет (кратно 1.0)
[BOTS] 02:41:08 - DEBUG - 🔍 CTC: Запрошенная сумма 1.32 USDT < minNotionalValue=5.0, но пропускаем принудительное увеличение (лимитный ордер из набора)
[BOTS] 02:41:08 - DEBUG - 💰 CTC: ФИНАЛЬНО: 4.0 монет @ 0.32970000 (кратно 1.0)
[BOTS] 02:41:08 - DEBUG - 🎯 CTC: order_params={'category': 'linear', 'symbol': 'CTCUSDT', 'side': 'Buy', 'orderType': 'Limit', 'qty': '4', 'positionIdx': 1}
[BOTS] 02:41:08 - DEBUG - 🔍 CTC: ДЕТАЛИ: qty='4' монет, orderType='Limit'
[BOTS] 02:41:08 - DEBUG - Параметры ордера: {'category': 'linear', 'symbol': 'CTCUSDT', 'side': 'Buy', 'orderType': 'Limit', 'qty': '4', 'positionIdx': 1, 'price': '0.324755', 'timeInForce': 'GTC'}
[BOTS] 02:41:08 - DEBUG - 🔍 CTC: ОТПРАВЛЯЕМ ЗАПРОС в Bybit API...
[BOTS] 02:41:08 - WARNING - Получен сигнал 2, начинаем graceful shutdown...
[BOTS] 02:41:08 - WARNING -  🛑 Auto Bot Worker остановлен
[BOTS] 02:41:08 - WARNING -  💾 Auto Save Worker остановлен
[BOTS] 02:41:08 - WARNING - 🔄 🛑 Останавливаем воркер...
[BOTS] 02:41:08 - ERROR - ❌ CTC: Pybit exception: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:08).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "4", "positionIdx": 1, "price": "0.324755", "timeInForce": "GTC"}.
[BOTS] 02:41:08 - ERROR - Ошибка размещения ордера: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:08).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "4", "positionIdx": 1, "price": "0.324755", "timeInForce": "GTC"}.
[BOTS] 02:41:08 - ERROR - Трейсбек: Traceback (most recent call last):
  File "C:\PROJECTS\InfoBot\exchanges\bybit_exchange.py", line 1978, in place_order
    raise api_error  # Пробрасываем дальше
    ^^^^^^^^^^^^^^^
  File "C:\PROJECTS\InfoBot\exchanges\bybit_exchange.py", line 1966, in place_order
...
pybit.exceptions.InvalidRequestError: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:08).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "4", "positionIdx": 1, "price": "0.324755", "timeInForce": "GTC"}.
[BOTS] 02:41:08 - WARNING -  CTC: ⚠️ Не удалось разместить лимитный ордер #4: Ошибка размещения ордера: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:08).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "4", "positionIdx": 1, "price": "0.324755", "timeInForce": "GTC"}.
[BOTS] 02:41:08 - DEBUG -  CTC: 📋 Ордер #5: percent_step=2%, margin_amount=1.5 USDT (из массива margin_amounts[4]=1.5)
[BOTS] 02:41:08 - DEBUG -  CTC: ✅ Используем для ордера #5: 1.5 USDT (self.volume_value=5, НЕ используется!)
[BOTS] 02:41:08 - DEBUG -  CTC: 🚀 Размещаем лимитный ордер #5: 1.5 USDT @ 0.323106 (2%)
[BOTS] 02:41:08 - DEBUG -  CTC: ✅ Используем 1.5 USDT из массива margin_amounts[4]=1.5, НЕ self.volume_value=5
[BOTS] 02:41:08 - DEBUG - 📊 Текущая цена CTC: 0.3297
[BOTS] 02:41:08 - WARNING -  🛑 Мониторинг позиций остановлен
[BOTS] 02:41:08 - DEBUG - 📊 CTC: minNotionalValue=5.0 USDT, minOrderQty=1.0, qtyStep=1.0
[BOTS] 02:41:08 - DEBUG - 📊 CTC: Плечо с биржи: 10.0x
[BOTS] 02:41:08 - DEBUG - 🎯 CTC: Запрошенная сумма из конфига: 1.5 USDT
[BOTS] 02:41:08 - DEBUG - 🔍 CTC: Исходное количество монет: 4.55
[BOTS] 02:41:08 - DEBUG - 🔍 CTC: Округлили 4.55 до 5.0 монет (кратно 1.0)
[BOTS] 02:41:08 - DEBUG - 🔍 CTC: Запрошенная сумма 1.65 USDT < minNotionalValue=5.0, но пропускаем принудительное увеличение (лимитный ордер из набора)
[BOTS] 02:41:08 - DEBUG - 💰 CTC: ФИНАЛЬНО: 5.0 монет @ 0.32970000 (кратно 1.0)
[BOTS] 02:41:08 - DEBUG - 🎯 CTC: order_params={'category': 'linear', 'symbol': 'CTCUSDT', 'side': 'Buy', 'orderType': 'Limit', 'qty': '5', 'positionIdx': 1}
[BOTS] 02:41:08 - DEBUG - 🔍 CTC: ДЕТАЛИ: qty='5' монет, orderType='Limit'
[BOTS] 02:41:08 - DEBUG - Параметры ордера: {'category': 'linear', 'symbol': 'CTCUSDT', 'side': 'Buy', 'orderType': 'Limit', 'qty': '5', 'positionIdx': 1, 'price': '0.323106', 'timeInForce': 'GTC'}
[BOTS] 02:41:08 - DEBUG - 🔍 CTC: ОТПРАВЛЯЕМ ЗАПРОС в Bybit API...
[BOTS] 02:41:09 - ERROR - ❌ CTC: Pybit exception: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:09).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "5", "positionIdx": 1, "price": "0.323106", "timeInForce": "GTC"}.
[BOTS] 02:41:09 - ERROR - Ошибка размещения ордера: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:09).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "5", "positionIdx": 1, "price": "0.323106", "timeInForce": "GTC"}.
[BOTS] 02:41:09 - ERROR - Трейсбек: Traceback (most recent call last):
  File "C:\PROJECTS\InfoBot\exchanges\bybit_exchange.py", line 1978, in place_order
    raise api_error  # Пробрасываем дальше
    ^^^^^^^^^^^^^^^
  File "C:\PROJECTS\InfoBot\exchanges\bybit_exchange.py", line 1966, in place_order
...
pybit.exceptions.InvalidRequestError: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:09).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "5", "positionIdx": 1, "price": "0.323106", "timeInForce": "GTC"}.
[BOTS] 02:41:09 - WARNING -  CTC: ⚠️ Не удалось разместить лимитный ордер #5: Ошибка размещения ордера: Order does not meet minimum order value 5USDT (ErrCode: 110094) (ErrTime: 23:41:09).
Request → POST https://api.bybit.com/v5/order/create: {"category": "linear", "symbol": "CTCUSDT", "side": "Buy", "orderType": "Limit", "qty": "5", "positionIdx": 1, "price": "0.323106", "timeInForce": "GTC"}.
[BOTS] 02:41:09 - ERROR -  CTC: Не удалось разместить ни одного ордера
[BOTS] 02:41:09 - ERROR - ❌ Не удалось открыть позицию LONG: no_orders_placed                
