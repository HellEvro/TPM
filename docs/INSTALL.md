...
1. **Установка зависимостей** — основной режим (`pip install -r requirements.txt` в системный Python)
2. **Виртуальное окружение (опционально)** — создать/удалить `.venv`, если нужна изоляция
