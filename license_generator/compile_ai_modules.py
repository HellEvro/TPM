...
ВАЖНО: .pyc файлы кладутся ПРЯМО в bot_engine/ai/ (без версионирования)
"""
...
def compile_ai_modules():
    ...
    # Целевая директория - прямо в bot_engine/ai/ (без версионирования!)
    target_dir = ai_dir
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for module_name in AI_MODULES:
            ...
            temp_file = temp_path / module_name
            ...
            try:
                ...
                if compiled_file and compiled_file.exists():
                    # Копируем как module.pyc в целевую директорию
