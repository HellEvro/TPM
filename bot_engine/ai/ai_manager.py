...
class AIManager:
    ...
    def load_modules(self):
        ...
        if not self.premium_loader.premium_available:
            ...
            logger.info("[AI]    1. Скопируйте папку InfoBot_AI_Premium/ в корень проекта")
            logger.info("[AI]    2. Приобретите лицензию - gci.company.ou@gmail.com")
            logger.info("[AI]    3. Поместите .lic файл в корень проекта")
            logger.info("[AI] ⚠️ AI функции будут отключены без модулей и лицензии")
            return
