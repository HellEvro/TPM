...
DEFAULT_AUTO_BOT_CONFIG = {
    ...
    'limit_orders_percent_steps': [0, 0.5, 1, 0, 0], # Шаги в % от цены входа (0 = рыночный, далее лимитные с увеличивающимся отступом)
    'limit_orders_margin_amounts': [0.5, 0.75, 1, 0, 0], # Объем маржи в USDT для каждого ордера (сумма = 5 USDT, увеличивается по мере удаления от входа)
