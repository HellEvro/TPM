...
DEFAULT_AUTO_BOT_CONFIG = {
    ...
    'trailing_stop_activation': 31,   # Процент прибыли, после которого активируется трейлинг
    'trailing_stop_distance': 11,      # Дистанция трейлинга от максимальной цены, %
    'trailing_take_distance': 0.51,    # Резервный trailing-тейк (лимит) в %, когда процесс упадет
